        ...
        <div className="flex flex-col gap-6 px-8 xl:px-12 py-12 w-full">
          ...
          <div>
            ...
            <p className="animate-element animate-delay-300 mt-2 text-sm leading-relaxed" style={{ color: '#6b7280' }}>
              Access your terminal and continue your on-chain journey.
            </p>
          </div>
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <div className="animate-element animate-delay-400 flex flex-col gap-1.5">
              ...
              <div
                className="rounded-2xl transition-all duration-200 focus-within:ring-1"
          ...
          <Link
            href="/register"
            className="animate-element animate-delay-800 block w-full text-center rounded-2xl py-3.5 text-sm font-semibold transition-all duration-200"
